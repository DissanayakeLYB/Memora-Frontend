        ...
        <div className="grid lg:grid-cols-2 gap-[clamp(1.5rem,4vw,4rem)] items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            >
              ...
              <span className="text-gradient-warm">wished</span> you had
            </h1>
            ...
            >
              <Link href={ROUTES.REQUEST} className="w-full sm:w-auto">
                <Button
                  size="lg"
                  className="w-full sm:w-auto text-[clamp(0.875rem,2vw,1rem)] px-[clamp(1.5rem,4vw,2.5rem)] py-[clamp(1rem,2.5vw,1.5rem)] group"
                >
                  Request Your Photos
              ...
              <Link href="#how-it-works" className="w-full sm:w-auto">
                <Button
                  variant="ghost"
                  size="lg"
                  className="w-full sm:w-auto text-[clamp(0.875rem,2vw,1rem)] px-[clamp(1rem,3vw,2rem)] py-[clamp(1rem,2.5vw,1.5rem)]"
                >
                  How it works
                </Button>
              </Link>
          ...
          <div
            className="flex items-center justify-center gap-[clamp(0.75rem,3vw,2rem)] animate-fade-in order-1 lg:order-2 mb-6 lg:mb-0"
          ...
          >
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-[clamp(0.625rem,1.5vw,0.875rem)] text-muted-foreground mt-[clamp(0.5rem,1.5vw,0.75rem)] font-medium text-center">
                What you give us
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-[clamp(0.625rem,1.5vw,0.875rem)] text-primary mt-[clamp(0.5rem,1.5vw,0.75rem)] font-medium text-center">
                What we give back
              </p>
            </div>
          </div>
